...
// NOTE: the v1 flat-struct SponsorIntent / CosponsorIntent type arrays
// were deleted with their builders (#595/#393 — the live path is the
// unified Envelope + per-action witness, fenced in the QPV2 block
// below). Their typehash regression entries were pruned accordingly.
