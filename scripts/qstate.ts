...
async function main() {
  ...
  const fields = ["status (0=void,1=open,2=settled,3=abandoned)","sponsor","oracle","token","minStakeFloor","stakeBasisPoints","minSponsorship","voteFee","abandonmentGracePeriod","contributorCount","solutionCount","poolAmount","sponsoredAt","fundingDeadline"];
